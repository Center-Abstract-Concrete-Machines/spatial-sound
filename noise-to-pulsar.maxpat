...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 648.0, 267.0, 150.0, 34.0 ],
					"presentation_linecount" : 2,
					"text" : "amplitude modulation scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 340.0, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 349.0, 366.0, 60.0, 22.0 ],
					"text" : "mc.pack~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 511.0, 408.0, 124.0, 22.0 ],
					"text" : "mc.pack~ @chans 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 329.5, 118.0, 22.0 ],
					"text" : "vexpr ($f1*400.)+40."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 311.0, 68.5, 80.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 137.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 132.0, 75.0, 167.0, 22.0 ],
...
, 								{
									"box" : 									{
										...
										"outlettype" : [ "" ],
										"id" : "obj-38",
										"patching_rect" : [ 128.0, 31.0, 139.0, 23.0 ]
									}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../Users/galajo/OneDrive/Documents/Max 8/Library/gen_noise-main/gen_noise-main/code",
				"type" : "GenX",
				"implicit" : 1
			}
, 			{
